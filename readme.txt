...
*Image upload is buggy *No support for default image *SQL injection not working on login and user.php *Problems with resposive layout *No age Calculatin algorithm currently added based on the date/time field in the databse.